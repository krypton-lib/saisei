...
public fun ByteMemory.readEBMLInteger_(type: EBMLIntegerType? = null): Long =
    asSlice().readEBMLInteger_(type)

public fun ByteSlice.readEBMLInteger_(type: EBMLIntegerType? = null): Long {
    val iter = iterator()
...
public fun ByteMemory.readEBMLInteger(type: EBMLIntegerType? = null): Long =
    asSlice().readEBMLInteger(type)

public fun ByteArray.readEBMLInteger(type: EBMLIntegerType? = null, offset: Int = 0): Long =
    asSlice(offset).readEBMLInteger(type)

public fun ByteSlice.readEBMLInteger(type: EBMLIntegerType? = null): Long {
    val iter = iterator()
 ...
 */
public enum class EBMLIntegerType {
    /**
