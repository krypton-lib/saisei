 ...
 */
public suspend fun ReadStream.readFixedSizeEBMLInteger(codeLength: Int, type: EBMLIntegerType? = null): Long {
    var code: Long = 0
 ...
 * @return Read EBML code
 */
public suspend fun ReadStream.readVariableEBMLInteger(type: EBMLIntegerType? = null): Long =
