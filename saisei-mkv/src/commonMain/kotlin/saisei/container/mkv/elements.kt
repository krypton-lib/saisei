...
import saisei.io.format.ebml.readEBMLInteger_ as readEBMLInteger
 ...
 */
public object Segment : ElementDeclaration.MASTER.Actual(
    EbmlID(
        "Segment",
        0x18, 0x53, 0x80, 0x67
    )
     ...
     */
    public object SeekHead : ElementDeclaration.MASTER.Actual(
        EbmlID(
            "SeekHead",
            0x11, 0x4D, 0x9B, 0x74
        )
         ...
         */
        public object Seek : ElementDeclaration.MASTER.Actual(
            EbmlID(
                "Seek", 0x4D,
                0xBB
            )
             ...
             */
            public val SeekID: ElementDeclaration.CUSTOM<EbmlID> =
             ...
             */
            public val SeekPosition: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "SeekPosition",
                        0x53, 0xAC
                    ), saisei.io.format.ebml.EBMLIntegerType.Unsigned
                )
     ...
     */
    public object Info : ElementDeclaration.MASTER.Actual(
        EbmlID(
            "Info", 0x15,
            0x49, 0xA9, 0x66
        )
         ...
         * actual UUID v4 value, where some bits are not random, **MAY** also be used.**Usage Notes**
         ...
         */
        public val SegmentUUID: ElementDeclaration.BINARY =
         ...
         */
        public val SegmentFilename: ElementDeclaration.STRING =
        ...
        /**
         * **Definition**
         * An ID to identify the previous Segment of a Linked Segment.**Usage Notes**
         ...
         */
        public val PrevUUID: ElementDeclaration.BINARY =
            ElementDeclaration.BINARY.Actual(
                EbmlID(
                    "PrevUUID",
                    0x3C, 0xB9, 0x23
        ...
        /**
         * **Definition**
         * A filename corresponding to the file of the previous Linked Segment.**Usage Notes**
         ...
         */
        public val PrevFilename: ElementDeclaration.STRING =
            ElementDeclaration.STRING.Actual(
                EbmlID(
                    "PrevFilename",
                    0x3C, 0x83, 0xAB
        ...
        /**
         * **Definition**
         * An ID to identify the next Segment of a Linked Segment.**Usage Notes**
         * If the Segment is a part of a Linked Segment that uses Hard Linking ((#hard-linking)), then
         ...
         */
        public val NextUUID: ElementDeclaration.BINARY =
            ElementDeclaration.BINARY.Actual(
                EbmlID(
                    "NextUUID",
                    0x3E, 0xB9, 0x23
        ...
        /**
         * **Definition**
         * A filename corresponding to the file of the next Linked Segment.**Usage Notes**
         ...
         */
        public val NextFilename: ElementDeclaration.STRING =
            ElementDeclaration.STRING.Actual(
                EbmlID(
                    "NextFilename",
                    0x3E, 0x83, 0xBB
         ...
         * value, where some bits are not random, **MAY** also be used.**Usage Notes**
         * If the Segment Info contains a `ChapterTranslate` element, this Element is **REQUIRED**.
         */
        public val SegmentFamily: ElementDeclaration.BINARY =
            ElementDeclaration.BINARY.Actual(
                EbmlID(
                    "SegmentFamily",
                    0x44, 0x44
         ...
         */
        public val TimestampScale: ElementDeclaration.INTEGER =
            ElementDeclaration.INTEGER.Actual(
                EbmlID(
                    "TimestampScale",
                    0x2A, 0xD7, 0xB1
         ...
         * (#timestamp-ticks).
         */
        public val Duration: ElementDeclaration.FLOAT =
         ...
         */
        public val DateUTC: ElementDeclaration.DATE =
         ...
         */
        public val Title: ElementDeclaration.STRING =
            ElementDeclaration.STRING.Actual(
                EbmlID(
                    "Title",
                    0x7B, 0xA9
        ...
        /**
         * **Definition**
         * Muxing application or library (example: "libmatroska-0.4.3").**Usage Notes**
         * Include the full name of the application or library followed by the version number.
         */
        public val MuxingApp: ElementDeclaration.STRING =
            ElementDeclaration.STRING.Actual(
                EbmlID(
                    "MuxingApp",
                    0x4D, 0x80
        ...
        /**
         * **Definition**
         * Writing application (example: "mkvmerge-0.3.3").**Usage Notes**
         * Include the full name of the application followed by the version number.
         */
        public val WritingApp: ElementDeclaration.STRING =
            ElementDeclaration.STRING.Actual(
                EbmlID(
                    "WritingApp",
                    0x57, 0x41
         ...
         * Segment mapping.
         */
        public object ChapterTranslate :
            ElementDeclaration.MASTER.Actual(
                EbmlID(
                    "ChapterTranslate", 0x69,
                    0x24
                )
            ) {
            /**
             ...
             */
            public val ChapterTranslateID: ElementDeclaration.BINARY =
                ElementDeclaration.BINARY.Actual(
                    EbmlID(
                        "ChapterTranslateID",
                        0x69, 0xA5
            ...
            /**
             * **Definition**
             * Specify a chapter edition UID on which this `ChapterTranslate` applies.**Usage Notes**
             ...
             */
            public val ChapterTranslateEditionUID: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
             ...
             */
            public enum class ChapterTranslateCodec(
                ...
                public companion object Declaration : ElementDeclaration.CUSTOM<ChapterTranslateCodec> {
                    override val id: EbmlID = EbmlID(
                        "ChapterTranslateCodec", 0x69,
                        0xBF
                    )

                    override suspend fun process(`data`: ByteMemory): ChapterTranslateCodec {
                        val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
     ...
     */
    public object Cluster : ElementDeclaration.MASTER.Actual(
        EbmlID(
            "Cluster",
            0x1F, 0x43, 0xB6, 0x75
        )
         ...
         * TimestampScale; see (#timestamp-ticks).**Usage Notes**
         ...
         */
        public val Timestamp: ElementDeclaration.INTEGER =
            ElementDeclaration.INTEGER.Actual(
                EbmlID(
                    "Timestamp",
                    0xE7
         ...
         */
        public val Position: ElementDeclaration.INTEGER =
            ElementDeclaration.INTEGER.Actual(
                EbmlID(
                    "Position",
                    0xA7
         ...
         */
        public val PrevSize: ElementDeclaration.INTEGER =
            ElementDeclaration.INTEGER.Actual(
                EbmlID(
                    "PrevSize",
                    0xAB
         ...
         * Structure.
         */
        public val SimpleBlock: ElementDeclaration.BINARY =
            ElementDeclaration.BINARY.Actual(
                EbmlID(
                    "SimpleBlock",
                    0xA3
         ...
         */
        public val EncryptedBlock: ElementDeclaration.BINARY =
            ElementDeclaration.BINARY.Actual(
                EbmlID(
                    "EncryptedBlock",
                    0xAF
        ...
        public object SilentTracks :
             ...
             */
            public val SilentTrackNumber: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "SilentTrackNumber",
                        0x58, 0xD7
        ...
        public object BlockGroup :
             ...
             */
            public val Block: ElementDeclaration.BINARY =
                ElementDeclaration.BINARY.Actual(
                    EbmlID(
                        "Block",
                        0xA1
             ...
             * in display order.
             */
            public val BlockVirtual: ElementDeclaration.BINARY =
                ElementDeclaration.BINARY.Actual(
                    EbmlID(
                        "BlockVirtual",
                        0xA2
             ...
             * for subtitle tracks.
             */
            public val BlockDuration: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "BlockDuration",
                        0x9B
             ...
             * referenced.
             */
            public val ReferencePriority: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "ReferencePriority",
                        0xFA
             ...
             */
            public val ReferenceBlock: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "ReferenceBlock",
                        0xFB
                    ), saisei.io.format.ebml.EBMLIntegerType.Signed
                )
             ...
             */
            public val ReferenceVirtual: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "ReferenceVirtual",
                        0xFD
             ...
             */
            public val CodecState: ElementDeclaration.BINARY =
                ElementDeclaration.BINARY.Actual(
                    EbmlID(
                        "CodecState",
                        0xA4
             ...
             */
            public val DiscardPadding: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "DiscardPadding",
                        0x75, 0xA2
            ...
            public object BlockAdditions :
                ...
                public object BlockMore :
                     ...
                     * of the BlockAdditional data is found in the BlockAddIDType found in the TrackEntry.**Usage
                     * Notes**
                     * Each BlockAddID value **MUST** be unique between all BlockMore elements found in a
                     * BlockAdditions.**Usage Notes**
                     * To keep MaxBlockAdditionID as low as possible, small values **SHOULD** be used.
                     */
                    public val BlockAddID: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "BlockAddID",
                                0xEE
             ...
             */
            public object Slices : ElementDeclaration.MASTER.Actual(
                EbmlID(
                    "Slices",
                    0x8E
                )
                ...
                public object TimeSlice :
                     ...
                     */
                    public val LaceNumber: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "LaceNumber",
                                0xCC
                     ...
                     */
                    public val FrameNumber: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "FrameNumber",
                                0xCD
                     ...
                     */
                    public val BlockAdditionID: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "BlockAdditionID",
                                0xCB
                     ...
                     */
                    public val Delay: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "Delay",
                                0xCE
                     ...
                     */
                    public val SliceDuration: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "SliceDuration",
                                0xCF
            ...
            public object ReferenceFrame :
                 ...
                 */
                public val ReferenceOffset: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "ReferenceOffset",
                            0xC9
                 ...
                 */
                public val ReferenceTimestamp: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "ReferenceTimestamp",
                            0xCA
     ...
     */
    public object Tracks : ElementDeclaration.MASTER.Actual(
        EbmlID(
            "Tracks",
            0x16, 0x54, 0xAE, 0x6B
        )
        ...
        public object TrackEntry :
             ...
             */
            public val TrackUID: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "TrackUID",
                        0x73, 0xC5
             ...
             */
            public val FlagEnabled: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FlagEnabled",
                        0xB9
             ...
             */
            public val FlagDefault: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FlagDefault",
                        0x88
             ...
             */
            public val FlagForced: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FlagForced",
                        0x55, 0xAA
             ...
             */
            public val FlagHearingImpaired: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FlagHearingImpaired",
                        0x55, 0xAB
             ...
             */
            public val FlagVisualImpaired: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FlagVisualImpaired",
                        0x55, 0xAC
             ...
             */
            public val FlagTextDescriptions: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
             ...
             */
            public val FlagOriginal: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FlagOriginal",
                        0x55, 0xAE
             ...
             */
            public val FlagCommentary: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FlagCommentary",
                        0x55, 0xAF
             ...
             */
            public val FlagLacing: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FlagLacing",
                        0x9C
             ...
             */
            public val MinCache: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "MinCache",
                        0x6D, 0xE7
             ...
             */
            public val MaxCache: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "MaxCache",
                        0x6D, 0xF8
             ...
             */
            public val DefaultDuration: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "DefaultDuration",
                        0x23, 0xE3, 0x83
             ...
             */
            public val DefaultDecodedFieldDuration: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
             ...
             */
            public val TrackTimestampScale: ElementDeclaration.FLOAT =
                ElementDeclaration.FLOAT.Actual(
                    EbmlID(
                        "TrackTimestampScale",
                        0x23, 0x31, 0x4F
             ...
             * track.
             */
            public val TrackOffset: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "TrackOffset",
                        0x53, 0x7F
             ...
             */
            public val MaxBlockAdditionID: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "MaxBlockAdditionID",
                        0x55, 0xEE
             ...
             */
            public val Name: ElementDeclaration.STRING =
                ElementDeclaration.STRING.Actual(
                    EbmlID(
                        "Name",
                        0x53, 0x6E
             ...
             * same TrackEntry.
             */
            public val Language: ElementDeclaration.STRING =
                ElementDeclaration.STRING.Actual(
                    EbmlID(
                        "Language",
                        0x22, 0xB5, 0x9C
             ...
             * ignored.
             */
            public val LanguageBCP47: ElementDeclaration.STRING =
                ElementDeclaration.STRING.Actual(
                    EbmlID(
                        "LanguageBCP47",
                        0x22, 0xB5, 0x9D
             ...
             */
            public val CodecID: ElementDeclaration.STRING =
                ElementDeclaration.STRING.Actual(
                    EbmlID(
                        "CodecID",
                        0x86
             ...
             */
            public val CodecPrivate: ElementDeclaration.BINARY =
                ElementDeclaration.BINARY.Actual(
                    EbmlID(
                        "CodecPrivate",
                        0x63, 0xA2
             ...
             */
            public val CodecName: ElementDeclaration.STRING =
                ElementDeclaration.STRING.Actual(
                    EbmlID(
                        "CodecName",
                        0x25, 0x86, 0x88
            ...
            /**
             * **Definition**
             * The UID of an attachment that is used by this codec.**Usage Notes**
             * The value **MUST** match the `FileUID` value of an attachment found in this Segment.
             */
            public val AttachmentLink: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "AttachmentLink",
                        0x74, 0x46
             ...
             */
            public val CodecSettings: ElementDeclaration.STRING =
                ElementDeclaration.STRING.Actual(
                    EbmlID(
                        "CodecSettings",
                        0x3A, 0x96, 0x97
             ...
             */
            public val CodecInfoURL: ElementDeclaration.STRING =
                ElementDeclaration.STRING.Actual(
                    EbmlID(
                        "CodecInfoURL",
                        0x3B, 0x40, 0x40
             ...
             */
            public val CodecDownloadURL: ElementDeclaration.STRING =
                ElementDeclaration.STRING.Actual(
                    EbmlID(
                        "CodecDownloadURL",
                        0x26, 0xB2, 0x40
             ...
             */
            public val CodecDecodeAll: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "CodecDecodeAll",
                        0xAA
             ...
             */
            public val TrackOverlay: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "TrackOverlay",
                        0x6F, 0xAB
             ...
             * Cluster.
             */
            public val CodecDelay: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "CodecDelay",
                        0x56, 0xAA
             ...
             * (#timestamp-ticks).
             */
            public val SeekPreRoll: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "SeekPreRoll",
                        0x56, 0xBB
             ...
             */
            public val TrickTrackUID: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "TrickTrackUID",
                        0xC0
             ...
             * [@?DivXTrickTrack].
             */
            public val TrickTrackSegmentUID: ElementDeclaration.BINARY =
                ElementDeclaration.BINARY.Actual(
                    EbmlID(
             ...
             */
            public val TrickTrackFlag: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "TrickTrackFlag",
                        0xC6
             ...
             */
            public val TrickMasterTrackUID: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "TrickMasterTrackUID",
                        0xC7
             ...
             * [@?DivXTrickTrack].
             */
            public val TrickMasterTrackSegmentUID: ElementDeclaration.BINARY =
                ElementDeclaration.BINARY.Actual(
                    EbmlID(
            ...
            public enum class TrackType(
                ...
                public companion object Declaration : ElementDeclaration.CUSTOM<TrackType> {
                    override val id: EbmlID = EbmlID("TrackType", 0x83)

                    override suspend fun process(`data`: ByteMemory): TrackType {
                        val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                        return entries.first { it.code == code }
                    }
                }
             ...
             */
            public object BlockAdditionMapping :
                ElementDeclaration.MASTER.Actual(
                    EbmlID(
                 ...
                 * BlockAddID ((#blockaddid-element)), value being described.**Usage Notes**
                 * To keep MaxBlockAdditionID as low as possible, small values **SHOULD** be used.
                 */
                public val BlockAddIDValue: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "BlockAddIDValue",
                            0x41, 0xF0
                 ...
                 */
                public val BlockAddIDName: ElementDeclaration.STRING =
                    ElementDeclaration.STRING.Actual(
                        EbmlID(
                            "BlockAddIDName",
                            0x41, 0xA4
                 ...
                 * BlockAdditional data should be handled.**Usage Notes**
                 * If BlockAddIDType is 0, the BlockAddIDValue and corresponding BlockAddID values **MUST**
                 * be 1.
                 */
                public val BlockAddIDType: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "BlockAddIDType",
                            0x41, 0xE7
                 ...
                 */
                public val BlockAddIDExtraData: ElementDeclaration.BINARY =
                    ElementDeclaration.BINARY.Actual(
                        EbmlID(
                            "BlockAddIDExtraData",
                            0x41, 0xED
            ...
            public object TrackTranslate :
                 ...
                 */
                public val TrackTranslateTrackID: ElementDeclaration.BINARY =
                    ElementDeclaration.BINARY.Actual(
                        EbmlID(
                ...
                /**
                 * **Definition**
                 * Specify a chapter edition UID on which this `TrackTranslate` applies.**Usage Notes**
                 ...
                 * `TrackTranslateCodec`.
                 */
                public val TrackTranslateEditionUID: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                 ...
                 * (#chapprocesscodecid-element).
                 */
                public enum class TrackTranslateCodec(
                    public val code: Long,
                ) {
                    /**
                     * **Definition**
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<TrackTranslateCodec> {
                        override val id: EbmlID = EbmlID(
                            "TrackTranslateCodec", 0x66,
                            0xBF
                        )

                        override suspend fun process(`data`: ByteMemory): TrackTranslateCodec {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
             ...
             * Video settings.
             */
            public object Video : ElementDeclaration.MASTER.Actual(
                EbmlID(
                    "Video",
                    0xE0
                )
                 ...
                 */
                public val PixelWidth: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "PixelWidth",
                            0xB0
                 ...
                 */
                public val PixelHeight: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "PixelHeight",
                            0xBA
                 ...
                 */
                public val PixelCropBottom: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "PixelCropBottom",
                            0x54, 0xAA
                 ...
                 */
                public val PixelCropTop: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "PixelCropTop",
                            0x54, 0xBB
                 ...
                 */
                public val PixelCropLeft: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "PixelCropLeft",
                            0x54, 0xCC
                 ...
                 */
                public val PixelCropRight: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "PixelCropRight",
                            0x54, 0xDD
                 ...
                 * (PixelCrop* Elements).
                 */
                public val DisplayWidth: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "DisplayWidth",
                            0x54, 0xB0
                 ...
                 * (PixelCrop* Elements).
                 */
                public val DisplayHeight: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "DisplayHeight",
                            0x54, 0xBA
                 ...
                 */
                public val UncompressedFourCC: ElementDeclaration.BINARY =
                    ElementDeclaration.BINARY.Actual(
                        EbmlID(
                            "UncompressedFourCC",
                            0x2E, 0xB5, 0x24
                 ...
                 * Gamma Value.
                 */
                public val GammaValue: ElementDeclaration.FLOAT =
                    ElementDeclaration.FLOAT.Actual(
                        EbmlID(
                            "GammaValue",
                            0x2F, 0xB5, 0x23
                 ...
                 */
                public val FrameRate: ElementDeclaration.FLOAT =
                    ElementDeclaration.FLOAT.Actual(
                        EbmlID(
                            "FrameRate",
                            0x23, 0x83, 0xE3
                 ...
                 */
                public enum class FlagInterlaced(
                    public val code: Long,
                ) {
                    /**
                     * **Definition**
                     * Unknown status.**Usage Notes**
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<FlagInterlaced> {
                        override val id: EbmlID = EbmlID("FlagInterlaced", 0x9A)

                        override suspend fun process(`data`: ByteMemory): FlagInterlaced {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
                ...
                /**
                 * **Definition**
                 * Specify the field ordering of video frames in this track.**Usage Notes**
                ...
                public enum class FieldOrder(
                    ...
                    /**
                     * **Definition**
                     * Unknown field order.**Usage Notes**
                     * This value **SHOULD** be avoided.
                     */
                    undetermined(2),
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<FieldOrder> {
                        override val id: EbmlID = EbmlID("FieldOrder", 0x9D)

                        override suspend fun process(`data`: ByteMemory): FieldOrder {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
                ...
                public enum class StereoMode(
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<StereoMode> {
                        override val id: EbmlID = EbmlID("StereoMode", 0x53, 0xB8)

                        override suspend fun process(`data`: ByteMemory): StereoMode {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
                ...
                public enum class AlphaMode(
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<AlphaMode> {
                        override val id: EbmlID = EbmlID("AlphaMode", 0x53, 0xC0)

                        override suspend fun process(`data`: ByteMemory): AlphaMode {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
                ...
                /**
                 * **Definition**
                 * Bogus StereoMode value used in old versions of libmatroska.**Usage Notes**
                 * This Element **MUST NOT** be used. It was an incorrect value used in libmatroska up to
                 * 0.9.0.
                 */
                public enum class OldStereoMode(
                    public val code: Long,
                ) {
                    mono(0),
                    `right eye`(1),
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<OldStereoMode> {
                        override val id: EbmlID = EbmlID("OldStereoMode", 0x53, 0xB9)

                        override suspend fun process(`data`: ByteMemory): OldStereoMode {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
                ...
                public enum class DisplayUnit(
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<DisplayUnit> {
                        override val id: EbmlID = EbmlID("DisplayUnit", 0x54, 0xB2)

                        override suspend fun process(`data`: ByteMemory): DisplayUnit {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
                 ...
                 */
                public enum class AspectRatioType(
                    public val code: Long,
                ) {
                    `free resizing`(0),
                    `keep aspect ratio`(1),
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<AspectRatioType> {
                        override val id: EbmlID = EbmlID("AspectRatioType", 0x54, 0xB3)

                        override suspend fun process(`data`: ByteMemory): AspectRatioType {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
                ...
                public object Colour :
                     ...
                     * unspecified.
                     */
                    public val BitsPerChannel: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "BitsPerChannel",
                                0x55, 0xB2
                     ...
                     * **SHOULD** be set to 1.
                     */
                    public val ChromaSubsamplingHorz: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                     ...
                     * **SHOULD** be set to 1.
                     */
                    public val ChromaSubsamplingVert: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                     ...
                     * **SHOULD** be set to 1.
                     */
                    public val CbSubsamplingHorz: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "CbSubsamplingHorz",
                                0x55, 0xB5
                     ...
                     */
                    public val CbSubsamplingVert: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "CbSubsamplingVert",
                                0x55, 0xB6
                     ...
                     * square meter (cd/m^2^).
                     */
                    public val MaxCLL: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "MaxCLL",
                                0x55, 0xBC
                     ...
                     */
                    public val MaxFALL: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "MaxFALL",
                                0x55, 0xBD
                    ...
                    public enum class MatrixCoefficients(
                        ...
                        public companion object Declaration : ElementDeclaration.CUSTOM<MatrixCoefficients> {
                            override val id: EbmlID = EbmlID(
                                "MatrixCoefficients", 0x55,
                                0xB1
                            )

                            override suspend fun process(`data`: ByteMemory): MatrixCoefficients {
                                val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                return entries.first { it.code == code }
                            }
                        }
                     ...
                     */
                    public enum class ChromaSitingHorz(
                        public val code: Long,
                    ) {
                        unspecified(0),
                        `left collocated`(1),
                        ...
                        public companion object Declaration : ElementDeclaration.CUSTOM<ChromaSitingHorz> {
                            override val id: EbmlID = EbmlID("ChromaSitingHorz", 0x55, 0xB7)

                            override suspend fun process(`data`: ByteMemory): ChromaSitingHorz {
                                val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                return entries.first { it.code == code }
                            }
                        }
                     ...
                     */
                    public enum class ChromaSitingVert(
                        public val code: Long,
                    ) {
                        unspecified(0),
                        `top collocated`(1),
                        ...
                        public companion object Declaration : ElementDeclaration.CUSTOM<ChromaSitingVert> {
                            override val id: EbmlID = EbmlID("ChromaSitingVert", 0x55, 0xB8)

                            override suspend fun process(`data`: ByteMemory): ChromaSitingVert {
                                val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                return entries.first { it.code == code }
                            }
                        }
                    ...
                    public enum class Range(
                        ...
                        public companion object Declaration : ElementDeclaration.CUSTOM<Range> {
                            override val id: EbmlID = EbmlID("Range", 0x55, 0xB9)

                            override suspend fun process(`data`: ByteMemory): Range {
                                val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                return entries.first { it.code == code }
                            }
                        }
                    ...
                    public enum class TransferCharacteristics(
                        ...
                        public companion object Declaration : ElementDeclaration.CUSTOM<TransferCharacteristics> {
                            override val id: EbmlID = EbmlID(
                                "TransferCharacteristics",
                                0x55, 0xBA
                            )

                            override suspend fun process(`data`: ByteMemory): TransferCharacteristics {
                                val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                return entries.first { it.code == code }
                            }
                        }
                    ...
                    public enum class Primaries(
                        ...
                        public companion object Declaration : ElementDeclaration.CUSTOM<Primaries> {
                            override val id: EbmlID = EbmlID("Primaries", 0x55, 0xBB)

                            override suspend fun process(`data`: ByteMemory): Primaries {
                                val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                return entries.first { it.code == code }
                            }
                        }
                     ...
                     */
                    public object MasteringMetadata :
                        ElementDeclaration.MASTER.Actual(
                            EbmlID(
                                "MasteringMetadata",
                                0x55, 0xD0
                         ...
                         */
                        public val PrimaryRChromaticityX: ElementDeclaration.FLOAT =
                            ElementDeclaration.FLOAT.Actual(
                                EbmlID(
                         ...
                         */
                        public val PrimaryRChromaticityY: ElementDeclaration.FLOAT =
                            ElementDeclaration.FLOAT.Actual(
                                EbmlID(
                         ...
                         */
                        public val PrimaryGChromaticityX: ElementDeclaration.FLOAT =
                            ElementDeclaration.FLOAT.Actual(
                                EbmlID(
                         ...
                         */
                        public val PrimaryGChromaticityY: ElementDeclaration.FLOAT =
                            ElementDeclaration.FLOAT.Actual(
                                EbmlID(
                         ...
                         */
                        public val PrimaryBChromaticityX: ElementDeclaration.FLOAT =
                            ElementDeclaration.FLOAT.Actual(
                                EbmlID(
                         ...
                         */
                        public val PrimaryBChromaticityY: ElementDeclaration.FLOAT =
                            ElementDeclaration.FLOAT.Actual(
                                EbmlID(
                         ...
                         */
                        public val WhitePointChromaticityX: ElementDeclaration.FLOAT =
                            ElementDeclaration.FLOAT.Actual(
                                EbmlID(
                         ...
                         */
                        public val WhitePointChromaticityY: ElementDeclaration.FLOAT =
                            ElementDeclaration.FLOAT.Actual(
                                EbmlID(
                         ...
                         */
                        public val LuminanceMax: ElementDeclaration.FLOAT =
                            ElementDeclaration.FLOAT.Actual(
                                EbmlID(
                                    "LuminanceMax",
                                    0x55, 0xD9
                         ...
                         */
                        public val LuminanceMin: ElementDeclaration.FLOAT =
                            ElementDeclaration.FLOAT.Actual(
                                EbmlID(
                                    "LuminanceMin",
                                    0x55, 0xDA
                ...
                public object Projection :
                     ...
                     */
                    public val ProjectionPrivate: ElementDeclaration.BINARY =
                        ElementDeclaration.BINARY.Actual(
                            EbmlID(
                                "ProjectionPrivate",
                                0x76, 0x72
                     ...
                     */
                    public val ProjectionPoseYaw: ElementDeclaration.FLOAT =
                        ElementDeclaration.FLOAT.Actual(
                            EbmlID(
                                "ProjectionPoseYaw",
                                0x76, 0x73
                     ...
                     */
                    public val ProjectionPosePitch: ElementDeclaration.FLOAT =
                        ElementDeclaration.FLOAT.Actual(
                            EbmlID(
                                "ProjectionPosePitch",
                                0x76, 0x74
                     ...
                     */
                    public val ProjectionPoseRoll: ElementDeclaration.FLOAT =
                        ElementDeclaration.FLOAT.Actual(
                            EbmlID(
                                "ProjectionPoseRoll",
                                0x76, 0x75
                    ...
                    public enum class ProjectionType(
                        ...
                        public companion object Declaration : ElementDeclaration.CUSTOM<ProjectionType> {
                            override val id: EbmlID = EbmlID("ProjectionType", 0x76, 0x71)

                            override suspend fun process(`data`: ByteMemory): ProjectionType {
                                val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                return entries.first { it.code == code }
                            }
                        }
             ...
             * Audio settings.
             */
            public object Audio : ElementDeclaration.MASTER.Actual(
                EbmlID(
                    "Audio",
                    0xE1
                )
                 ...
                 */
                public val SamplingFrequency: ElementDeclaration.FLOAT =
                    ElementDeclaration.FLOAT.Actual(
                        EbmlID(
                            "SamplingFrequency",
                            0xB5
                 ...
                 */
                public val OutputSamplingFrequency: ElementDeclaration.FLOAT =
                    ElementDeclaration.FLOAT.Actual(
                        EbmlID(
                 ...
                 */
                public val Channels: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "Channels",
                            0x9F
                 ...
                 */
                public val ChannelPositions: ElementDeclaration.BINARY =
                    ElementDeclaration.BINARY.Actual(
                        EbmlID(
                            "ChannelPositions",
                            0x7D, 0x7B
                 ...
                 */
                public val BitDepth: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "BitDepth",
                            0x62, 0x64
                ...
                public enum class Emphasis(
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<Emphasis> {
                        override val id: EbmlID = EbmlID("Emphasis", 0x52, 0xF1)

                        override suspend fun process(`data`: ByteMemory): Emphasis {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
            ...
            public object TrackOperation :
                 ...
                 * track
                 */
                public object TrackCombinePlanes :
                    ElementDeclaration.MASTER.Actual(
                        EbmlID(
                            "TrackCombinePlanes",
                            0xE3
                    ...
                    public object TrackPlane :
                         ...
                         */
                        public enum class TrackPlaneType(
                            public val code: Long,
                        ) {
                            `left eye`(0),
                            `right eye`(1),
                            ...
                            public companion object Declaration : ElementDeclaration.CUSTOM<TrackPlaneType> {
                                override val id: EbmlID = EbmlID("TrackPlaneType", 0xE6)

                                override suspend fun process(`data`: ByteMemory): TrackPlaneType {
                                    val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                    return entries.first { it.code == code }
                                }
                            }
                ...
                public object TrackJoinBlocks :
                     ...
                     */
                    public val TrackJoinUID: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "TrackJoinUID",
                                0xED
             ...
             */
            public object ContentEncodings :
                ElementDeclaration.MASTER.Actual(
                    EbmlID(
                        "ContentEncodings", 0x6D,
                        0x80
                    )
                ) {
                init {
                ...
                public object ContentEncoding :
                     ...
                     */
                    public val ContentEncodingOrder: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                     ...
                     */
                    public enum class ContentEncodingScope(
                        public val code: Long,
                    ) {
                        /**
                         * **Definition**
                         ...
                         * `ContentCompression` and/or `ContentEncryption`).**Usage Notes**
                         * This value **SHOULD NOT** be used as it's not supported by players.
                         */
                        Next(4),
                        ;

                        public companion object Declaration : ElementDeclaration.CUSTOM<ContentEncodingScope> {
                            override val id: EbmlID = EbmlID(
                                "ContentEncodingScope", 0x50,
                                0x32
                            )

                            override suspend fun process(`data`: ByteMemory): ContentEncodingScope {
                                val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                return entries.first { it.code == code }
                            }
                        }
                     ...
                     */
                    public enum class ContentEncodingType(
                        public val code: Long,
                    ) {
                        Compression(0),
                        Encryption(1),
                        ...
                        public companion object Declaration : ElementDeclaration.CUSTOM<ContentEncodingType> {
                            override val id: EbmlID = EbmlID(
                                "ContentEncodingType", 0x50,
                                0x33
                            )

                            override suspend fun process(`data`: ByteMemory): ContentEncodingType {
                                val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                return entries.first { it.code == code }
                            }
                        }
                     ...
                     */
                    public object ContentCompression :
                        ElementDeclaration.MASTER.Actual(
                            EbmlID(
                                "ContentCompression",
                                0x50, 0x34
                         ...
                         * the track.
                         */
                        public val ContentCompSettings: ElementDeclaration.BINARY =
                            ElementDeclaration.BINARY.Actual(
                                EbmlID(
                                    "ContentCompSettings",
                                    0x42, 0x55
                        ...
                        /**
                         * **Definition**
                         * The compression algorithm used.**Usage Notes**
                         ...
                         */
                        public enum class ContentCompAlgo(
                            public val code: Long,
                        ) {
                            /**
                             * **Definition**
                            ...
                            public companion object Declaration : ElementDeclaration.CUSTOM<ContentCompAlgo> {
                                override val id: EbmlID = EbmlID(
                                    "ContentCompAlgo", 0x42,
                                    0x54
                                )

                                override suspend fun process(`data`: ByteMemory): ContentCompAlgo {
                                    val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                    return entries.first { it.code == code }
                                }
                            }
                    ...
                    public object ContentEncryption :
                         ...
                         * with.
                         */
                        public val ContentEncKeyID: ElementDeclaration.BINARY =
                            ElementDeclaration.BINARY.Actual(
                                EbmlID(
                                    "ContentEncKeyID",
                                    0x47, 0xE2
                         ...
                         */
                        public val ContentSignature: ElementDeclaration.BINARY =
                            ElementDeclaration.BINARY.Actual(
                                EbmlID(
                                    "ContentSignature",
                                    0x47, 0xE3
                         ...
                         */
                        public val ContentSigKeyID: ElementDeclaration.BINARY =
                            ElementDeclaration.BINARY.Actual(
                                EbmlID(
                                    "ContentSigKeyID",
                                    0x47, 0xE4
                         ...
                         */
                        public enum class ContentEncAlgo(
                            public val code: Long,
                        ) {
                            /**
                             * **Definition**
                            ...
                            /**
                             * **Definition**
                             * Data Encryption Standard (DES) [@?FIPS.46-3].**Usage Notes**
                             * This value **SHOULD** be avoided.
                             */
                            DES(1),
                            ...
                            /**
                             * **Definition**
                             * Triple Data Encryption Algorithm [@?SP.800-67].**Usage Notes**
                             * This value **SHOULD** be avoided.
                             */
                            `3DES`(2),
                            ...
                            /**
                             * **Definition**
                             * Blowfish Encryption Algorithm [@?Blowfish].**Usage Notes**
                             * This value **SHOULD** be avoided.
                             */
                            Blowfish(4),
                            ...
                            public companion object Declaration : ElementDeclaration.CUSTOM<ContentEncAlgo> {
                                override val id: EbmlID = EbmlID("ContentEncAlgo", 0x47, 0xE1)

                                override suspend fun process(`data`: ByteMemory): ContentEncAlgo {
                                    val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                    return entries.first { it.code == code }
                                }
                            }
                         ...
                         */
                        public enum class ContentSigAlgo(
                            public val code: Long,
                        ) {
                            `Not signed`(0),
                            RSA(1),
                            ...
                            public companion object Declaration : ElementDeclaration.CUSTOM<ContentSigAlgo> {
                                override val id: EbmlID = EbmlID("ContentSigAlgo", 0x47, 0xE5)

                                override suspend fun process(`data`: ByteMemory): ContentSigAlgo {
                                    val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                    return entries.first { it.code == code }
                                }
                            }
                         ...
                         */
                        public enum class ContentSigHashAlgo(
                            public val code: Long,
                        ) {
                            `Not signed`(0),
                            `SHA1-160`(1),
                            ...
                            public companion object Declaration : ElementDeclaration.CUSTOM<ContentSigHashAlgo> {
                                override val id: EbmlID = EbmlID(
                                    "ContentSigHashAlgo", 0x47,
                                    0xE6
                                )

                                override suspend fun process(`data`: ByteMemory): ContentSigHashAlgo {
                                    val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                    return entries.first { it.code == code }
                                }
                            }
                         ...
                         */
                        public object ContentEncAESSettings :
                            ElementDeclaration.MASTER.Actual(
                                EbmlID(
                             ...
                             */
                            public enum class AESSettingsCipherMode(
                                public val code: Long,
                            ) {
                                /**
                                 * **Definition**
                                ...
                                public companion object Declaration :
                                    ...
                                    override suspend fun process(`data`: ByteMemory): AESSettingsCipherMode {
                                        val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                        return entries.first { it.code == code }
                                    }
                                }
     ...
     */
    public object Cues : ElementDeclaration.MASTER.Actual(
        EbmlID(
            "Cues", 0x1C,
            0x53, 0xBB, 0x6B
        )
        ...
        public object CuePoint :
             ...
             * see (#timestamp-ticks).
             */
            public val CueTime: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "CueTime",
                        0xB3
            ...
            public object CueTrackPositions :
                 ...
                 * Block.
                 */
                public val CueClusterPosition: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "CueClusterPosition",
                            0xF1
                 ...
                 */
                public val CueRelativePosition: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "CueRelativePosition",
                            0xF0
                 ...
                 */
                public val CueDuration: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "CueDuration",
                            0xB2
                 ...
                 */
                public val CueBlockNumber: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "CueBlockNumber",
                            0x53, 0x78
                 ...
                 */
                public val CueCodecState: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "CueCodecState",
                            0xEA
                ...
                public object CueReference :
                     ...
                     * see (#timestamp-ticks).
                     */
                    public val CueRefTime: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "CueRefTime",
                                0x96
                     ...
                     */
                    public val CueRefCluster: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "CueRefCluster",
                                0x97
                     ...
                     */
                    public val CueRefNumber: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "CueRefNumber",
                                0x53, 0x5F
                     ...
                     */
                    public val CueRefCodecState: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "CueRefCodecState",
                                0xEB
    ...
    public object Attachments :
        ...
        public object AttachedFile :
             ...
             */
            public val FileName: ElementDeclaration.STRING =
                ElementDeclaration.STRING.Actual(
                    EbmlID(
                        "FileName",
                        0x46, 0x6E
             ...
             */
            public val FileMediaType: ElementDeclaration.STRING =
                ElementDeclaration.STRING.Actual(
                    EbmlID(
                        "FileMediaType",
                        0x46, 0x60
             ...
             */
            public val FileData: ElementDeclaration.BINARY =
                ElementDeclaration.BINARY.Actual(
                    EbmlID(
                        "FileData",
                        0x46, 0x5C
             ...
             */
            public val FileUID: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FileUID",
                        0x46, 0xAE
             ...
             */
            public val FileReferral: ElementDeclaration.BINARY =
                ElementDeclaration.BINARY.Actual(
                    EbmlID(
                        "FileReferral",
                        0x46, 0x75
             ...
             * Segment Ticks which is based on TimestampScale. See [@?DivXWorldFonts].**Usage Notes**
             * This element is reserved for future use and if written **MUST** be the segment start
             * timestamp.
             */
            public val FileUsedStartTime: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FileUsedStartTime",
                        0x46, 0x61
             ...
             * timestamp.
             */
            public val FileUsedEndTime: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "FileUsedEndTime",
                        0x46, 0x62
     ...
     */
    public object Chapters : ElementDeclaration.MASTER.Actual(
        EbmlID(
            "Chapters",
            0x10, 0x43, 0xA7, 0x70
        )
        ...
        public object EditionEntry :
             ...
             */
            public val EditionUID: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "EditionUID",
                        0x45, 0xBC
             ...
             */
            public val EditionFlagHidden: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "EditionFlagHidden",
                        0x45, 0xBD
             ...
             */
            public val EditionFlagDefault: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "EditionFlagDefault",
                        0x45, 0xDB
             ...
             */
            public val EditionFlagOrdered: ElementDeclaration.INTEGER =
                ElementDeclaration.INTEGER.Actual(
                    EbmlID(
                        "EditionFlagOrdered",
                        0x45, 0xDD
            ...
            public object EditionDisplay :
                 ...
                 */
                public val EditionString: ElementDeclaration.STRING =
                    ElementDeclaration.STRING.Actual(
                        EbmlID(
                            "EditionString",
                            0x45, 0x21
                 ...
                 */
                public val EditionLanguageIETF: ElementDeclaration.STRING =
                    ElementDeclaration.STRING.Actual(
                        EbmlID(
                            "EditionLanguageIETF",
                            0x45, 0xE4
            ...
            public object ChapterAtom :
                 ...
                 */
                public val ChapterStringUID: ElementDeclaration.STRING =
                    ElementDeclaration.STRING.Actual(
                        EbmlID(
                            "ChapterStringUID",
                            0x56, 0x54
                 ...
                 * see (#timestamp-ticks).
                 */
                public val ChapterTimeStart: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "ChapterTimeStart",
                            0x91
                 ...
                 * `ChapterTimeStart` of the same `ChapterAtom`.**Usage Notes**
                 ...
                 */
                public val ChapterTimeEnd: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "ChapterTimeEnd",
                            0x92
                 ...
                 */
                public val ChapterFlagHidden: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "ChapterFlagHidden",
                            0x98
                 ...
                 */
                public val ChapterFlagEnabled: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "ChapterFlagEnabled",
                            0x45, 0x98
                ...
                /**
                 * **Definition**
                 * The SegmentUUID of another Segment to play during this chapter.**Usage Notes**
                 * The value **MUST NOT** be the `SegmentUUID` value of the `Segment` it belongs to.
                 */
                public val ChapterSegmentUUID: ElementDeclaration.BINARY =
                    ElementDeclaration.BINARY.Actual(
                        EbmlID(
                            "ChapterSegmentUUID",
                            0x6E, 0x67
                 ...
                 */
                public val ChapterSegmentEditionUID: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                 ...
                 */
                public val ChapterPhysicalEquiv: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                 ...
                 */
                public enum class ChapterSkipType(
                    public val code: Long,
                ) {
                    /**
                     * **Definition**
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<ChapterSkipType> {
                        override val id: EbmlID = EbmlID("ChapterSkipType", 0x45, 0x88)

                        override suspend fun process(`data`: ByteMemory): ChapterSkipType {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
                ...
                public object ChapterTrack :
                     ...
                     */
                    public val ChapterTrackUID: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "ChapterTrackUID",
                                0x89
                ...
                public object ChapterDisplay :
                     ...
                     */
                    public val ChapLanguage: ElementDeclaration.STRING =
                        ElementDeclaration.STRING.Actual(
                            EbmlID(
                                "ChapLanguage",
                                0x43, 0x7C
                     ...
                     */
                    public val ChapLanguageBCP47: ElementDeclaration.STRING =
                        ElementDeclaration.STRING.Actual(
                            EbmlID(
                                "ChapLanguageBCP47",
                                0x43, 0x7D
                     ...
                     */
                    public val ChapCountry: ElementDeclaration.STRING =
                        ElementDeclaration.STRING.Actual(
                            EbmlID(
                                "ChapCountry",
                                0x43, 0x7E
                ...
                public object ChapProcess :
                     ...
                     */
                    public val ChapProcessCodecID: ElementDeclaration.INTEGER =
                        ElementDeclaration.INTEGER.Actual(
                            EbmlID(
                                "ChapProcessCodecID",
                                0x69, 0x55
                     ...
                     * menus.
                     */
                    public val ChapProcessPrivate: ElementDeclaration.BINARY =
                        ElementDeclaration.BINARY.Actual(
                            EbmlID(
                                "ChapProcessPrivate",
                                0x45, 0x0D
                     ...
                     * Contains all the commands associated to the Atom.
                     */
                    public object ChapProcessCommand :
                        ElementDeclaration.MASTER.Actual(
                            EbmlID(
                                "ChapProcessCommand",
                                0x69, 0x11
                         ...
                         */
                        public val ChapProcessData: ElementDeclaration.BINARY =
                            ElementDeclaration.BINARY.Actual(
                                EbmlID(
                                    "ChapProcessData",
                                    0x69, 0x33
                         ...
                         */
                        public enum class ChapProcessTime(
                            public val code: Long,
                        ) {
                            ...
                            public companion object Declaration : ElementDeclaration.CUSTOM<ChapProcessTime> {
                                override val id: EbmlID = EbmlID(
                                    "ChapProcessTime", 0x69,
                                    0x22
                                )

                                override suspend fun process(`data`: ByteMemory): ChapProcessTime {
                                    val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                                    return entries.first { it.code == code }
                                }
                            }
     ...
     */
    public object Tags : ElementDeclaration.MASTER.Actual(
        EbmlID(
            "Tags", 0x12,
            0x54, 0xC3, 0x67
        )
         ...
         */
        public object Tag : ElementDeclaration.MASTER.Actual(
            EbmlID(
                "Tag", 0x73,
                0x73
            )
            ...
            public object Targets :
                 ...
                 */
                public val TargetType: ElementDeclaration.STRING =
                    ElementDeclaration.STRING.Actual(
                        EbmlID(
                            "TargetType",
                            0x63, 0xCA
                ...
                /**
                 * **Definition**
                 * A unique ID to identify the Track(s) the tags belong to.**Usage Notes**
                 ...
                 */
                public val TagTrackUID: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "TagTrackUID",
                            0x63, 0xC5
                ...
                /**
                 * **Definition**
                 * A unique ID to identify the EditionEntry(s) the tags belong to.**Usage Notes**
                 ...
                 * Segment.
                 */
                public val TagEditionUID: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "TagEditionUID",
                            0x63, 0xC9
                ...
                /**
                 * **Definition**
                 * A unique ID to identify the Chapter(s) the tags belong to.**Usage Notes**
                 ...
                 * Segment.
                 */
                public val TagChapterUID: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "TagChapterUID",
                            0x63, 0xC4
                ...
                /**
                 * **Definition**
                 * A unique ID to identify the Attachment(s) the tags belong to.**Usage Notes**
                 ...
                 * Segment.
                 */
                public val TagAttachmentUID: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "TagAttachmentUID",
                            0x63, 0xC6
                 ...
                 */
                public enum class TargetTypeValue(
                    public val code: Long,
                ) {
                    /**
                     * **Definition**
                    ...
                    public companion object Declaration : ElementDeclaration.CUSTOM<TargetTypeValue> {
                        override val id: EbmlID = EbmlID("TargetTypeValue", 0x68, 0xCA)

                        override suspend fun process(`data`: ByteMemory): TargetTypeValue {
                            val code = data.readEBMLInteger(saisei.io.format.ebml.EBMLIntegerType.Unsigned)
                            return entries.first { it.code == code }
                        }
                    }
            ...
            public object SimpleTag :
                 ...
                 */
                public val TagLanguage: ElementDeclaration.STRING =
                    ElementDeclaration.STRING.Actual(
                        EbmlID(
                            "TagLanguage",
                            0x44, 0x7A
                 ...
                 */
                public val TagLanguageBCP47: ElementDeclaration.STRING =
                    ElementDeclaration.STRING.Actual(
                        EbmlID(
                            "TagLanguageBCP47",
                            0x44, 0x7B
                 ...
                 * tag.
                 */
                public val TagDefault: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "TagDefault",
                            0x44, 0x84
                 ...
                 */
                public val TagDefaultBogus: ElementDeclaration.INTEGER =
                    ElementDeclaration.INTEGER.Actual(
                        EbmlID(
                            "TagDefaultBogus",
                            0x44, 0xB4
                 ...
                 */
                public val TagString: ElementDeclaration.STRING =
                    ElementDeclaration.STRING.Actual(
                        EbmlID(
                            "TagString",
                            0x44, 0x87
                 ...
                 */
                public val TagBinary: ElementDeclaration.BINARY =
                    ElementDeclaration.BINARY.Actual(
                        EbmlID(
                            "TagBinary",
                            0x44, 0x85
