...
interface MasterElement : Element {
    /**
    ...
    suspend fun <T> consume(block: suspend MasterElementReader.() -> T): T

    @ExperimentalSaiseiApi
    fun reader(): MasterElementReader

    data class Actual(override val header: ElementHeader, override val children: List<Element>) : MasterElement {
